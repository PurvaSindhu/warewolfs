...
public class Perfumes {
	...
	public int hashCode() {
		...
		results = results * prime + storeName.hashCode();
		results = results * prime + gucci.hashCode();
		results = results * prime + jenniferAniston.hashCode();
		results = results * prime + yardley.hashCode();
		results = results * prime + fantasy.hashCode();
		results = results * prime + zudio.hashCode();
		results = results * prime+denver.hashCode();
		results = results * prime + zara.hashCode();
		results = results * prime + carltonLandon.hashCode();
		results = results * prime + afforable.hashCode();
