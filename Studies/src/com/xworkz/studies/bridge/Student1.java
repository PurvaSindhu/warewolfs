...
import com.xworkz.studies.things.*;

public class Student1 extends WorkPlace implements School,Collage,University,PreSchool{
	...
	public void UniversityName() {
		System.out.println("this is university method");
